  ...
  return (
    ...
    <Container fluid className="p-3 m-3 rounded-2" style={{maxWidth: '700px', overflowWrap: 'break-word'}}>
      ...
      (
          ...
          <Row>
          <Button onClick={() => openInfo("PROJECTS")} className="bg-gradient p-3 mb-4 rounded-1" style={{backgroundColor: '#f5a65b', border: 'none', fontSize: '20px'}}>
            Projects
          </Button>
          </Row>
          <Row>
          <Button onClick={() => openInfo("EXPERIENCE")} className="bg-gradient p-3 mb-4 rounded-1" style={{backgroundColor: '#f5a65b', border: 'none', fontSize: '20px'}}>
            Experience
          </Button>
          </Row>      
          </Col>
