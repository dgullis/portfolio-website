...
export const TitleSection = () => {
    ...
    return (
        <Container fluid >
            ...
            DAN GULLIS
            {/* <span style={{fontFamily: 'Armitage', fontSize: 'calc(50px + 3vw)', letterSpacing: '4px', color: 'white', fontWeight: '100', textAlign: 'center', textShadow: '0.5px 0.5px 0.5px rgba(0, 0, 0, 0.3)'}}>
